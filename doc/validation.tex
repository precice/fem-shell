 ...
 \subsection{Test G: MPI (Increasing Number of Processes)}\label{sec:valid-G}
  ...
  \begin{table}[htbp]
   ...
   \begin{figure}[htbp]
   	...
   	grid=major,
   	legend pos=outer north east]
   	\addplot[mark=o,loosely dashdotted,gray,mark options={solid, line width=0.7pt}, line width=1.5pt] plot coordinates {
   		(1,49.35)
   		(2,35.65)
   		(3,40.47)
   		(4,33.31)
   	...
   	\addlegendentry{Tri-3 min}
   	\addplot[mark=o,dotted,gray,mark options={solid, line width=0.7pt}, line width=1.5pt] plot coordinates {
   		(1,50.96)
   		(2,37.36)
   		(3,41.57)
   		(4,34.93)
   	...
   	\addlegendentry{Tri-3 avg}
   	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
   	\addplot[mark=x,loosely dashdotted,gray,mark options={scale=1.5,solid, line width=0.7pt}, line width=1.5pt] plot coordinates {
   		(1,31.88)
   		(2,23.67)
   		(3,26.05)
   		(4,21.53)
   	...
   	\addlegendentry{Quad-4 min}
   	\addplot[mark=x,dotted,gray,mark options={scale=1.5,solid, line width=0.7pt}, line width=1.5pt] plot coordinates {
   		(1,33.29)
   		(2,24.75)
   		(3,26.95)
   		(4,23.05)

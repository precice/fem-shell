...
\end{lstlisting}
   ...
   For this purpose let $\tilde{T}$ be the $6\!\times\! 6$ transformation matrix from equation \eqref{eq:trafoTtilde}. Now, every submatrix $K_{ij}$ from $K$ must be transformed in the following way (equation \eqref{eq:Kij=Tt Kij T}):
   \begin{equation*}
